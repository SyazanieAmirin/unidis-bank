    ...
    return (
        <div class="w-full max-w-[1200px] flex flex-row justify-between items-center px-4">
            ...
            <div class="flex flex-row gap-14 items-center">
                <a href="/user-dashboard"><h3 class="transition-all hover:text-black/60 cursor-pointer text-black">Home</h3></a>
                <a href="/account-summary"><h3 class="transition-all hover:text-black/60 cursor-pointer text-black">Account Summary</h3></a>
                <a href="/transfer"><h3 class="transition-all hover:text-black/60 cursor-pointer text-black">Transfer</h3></a>
