    ...
    return (
        <div className="w-full max-w-[1200px] flex flex-row justify-between items-center px-4">
            ...
            <div className="flex flex-row gap-14 items-center">
                ...
                <a href="/"><h3 className="transition-all hover:text-black/60 cursor-pointer text-black">Goals</h3></a>
                <a href="/"><h3 className="transition-all hover:text-black/60 cursor-pointer text-black">Statistics</h3></a>
