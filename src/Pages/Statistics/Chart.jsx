    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                ...
                const userIdResponse = await fetch(`https://unidis-bank.onrender.com/api/userId/${storedUsername}`);
                const userIdData = await userIdResponse.json();
                const userId = userIdData.id;

                // Get transactions by userId
                const transactionsResponse = await fetch(`https://unidis-bank.onrender.com/api/user/${userId}/transactions`);
